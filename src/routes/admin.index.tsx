...
import { Cpu, ClipboardList, Download, ArrowRight, ShieldCheck } from "lucide-react";
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">Configure hardware parameters, loop testing and serial interfaces.</p>
            </div>
            <div className="flex items-center gap-1.5 text-xs text-yellow-400 font-medium mt-4">
              Access Terminal <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
            </div>
